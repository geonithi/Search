...
var map = new ol.Map({
    ...
    layers: layersList,
    view: new ol.View({
        extent: [5621809.864336, 3016872.389921, 5621906.460913, 3016903.690699], maxZoom: 28, minZoom: 9
    })
});

//initial view - epsg:3857 coordinates if not "Match project CRS"
map.getView().fit([5621809.864336, 3016872.389921, 5621906.460913, 3016903.690699], map.getSize());
